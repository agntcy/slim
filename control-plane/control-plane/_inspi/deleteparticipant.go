...
func main() {
	...
	deleteParticipantRequest := &controlplaneApi.DeleteParticipantRequest{
		ParticipantId: "participant3",                  // Replace with actual participant ID to add
		ChannelId:     "moderator1-wJcF4BhQbxc4N0icik", // Replace with actual channel ID to delete
	}
	ack, err := client.DeleteParticipant(context.Background(), deleteParticipantRequest)
	if err != nil {

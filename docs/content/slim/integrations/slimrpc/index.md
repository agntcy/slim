...
[example
protobuf](https://github.com/agntcy/slim-bindings/blob/main/python/examples/slimrpc/simple/example.proto)
...
[example](https://github.com/agntcy/slim-bindings/tree/main/python/examples/slimrpc/simple)
folder.
...
[server.py](https://github.com/agntcy/slim-bindings/blob/main/python/examples/slimrpc/simple/server.py).
...
[client.py](https://github.com/agntcy/slim-bindings/blob/main/python/examples/slimrpc/simple/client.py),
...
(see the [doc](../../components/data-plane/index.md) for more details). Here we will use

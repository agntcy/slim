        ...
        match message {
            ...
            SessionMessage::TimerFailure {
                ...
                if message_type.is_command_message() {
                    ...
                    {
                        // the rejoin request did not succed, notify the application with an error
                        ...
                        } else if pending_task.message_type == ProtoSessionMessageType::UpdateParticipantState {

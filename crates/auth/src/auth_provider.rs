...
//!     "service-id",
//!     "shared-secret-value-0123456789abcdef",
//! )?;
...
//!     AuthProvider::shared_secret_from_str(
//!         "id",
//!         "shared-secret-value-0123456789abcdef",
//!     )?,
//! );
//! let verifier = Arc::new(
//!     AuthVerifier::shared_secret_from_str(
//!         "id",
//!         "shared-secret-value-0123456789abcdef",
//!     )?,
//! );
...
///let provider =
///    AuthProvider::shared_secret_from_str("my-service", "shared-secret-value-0123456789abcdef")
///        .unwrap();
///let token = provider.get_token().unwrap();
...
///        .unwrap();
///let verifier =
///    AuthVerifier::shared_secret_from_str("my-service", "shared-secret-value-0123456789abcdef")
///        .unwrap();
///

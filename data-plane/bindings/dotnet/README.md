...
task publish          # Publish NuGet package (requires NUGET_API_KEY)
task test:verify-package  # Verify NuGet package locally
...
The NuGet package is automatically published when a release tag is pushed (e.g., `slim-bindings-libs-v0.1.0`). The release workflow:
...
**Required GitHub Secret:** `NUGET_API_KEY`
...
task publish NUGET_API_KEY=<your-api-key>

...
use crate::session::SessionInterceptor;
...
where
    ...
    V: Verifier + Send + Sync + Clone + 'static,
{
    pub fn new(mls: Arc<Mutex<Mls<P, V>>>, group_id: Vec<u8>) -> Self {
...
mod tests {
    ...
    async fn test_mls_interceptor_without_group() {
        ...
        let mut mls = Mls::new(
            agent,
            slim_auth::simple::Simple::new("secret"),
            slim_auth::simple::Simple::new("secret"),
        );
    ...
    async fn test_mls_interceptor_with_group() {
        ...
        let mut alice_mls = Mls::new(
            alice_agent,
            slim_auth::simple::Simple::new("alice_token"),
            slim_auth::simple::Simple::new("alice_token"),
        );
        ...
        let mut bob_mls = Mls::new(
            bob_agent,
            slim_auth::simple::Simple::new("bob_token"),
            slim_auth::simple::Simple::new("bob_token"),
        );

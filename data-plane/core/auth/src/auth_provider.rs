...
//! let provider = AuthProvider::shared_secret_from_str("service-id", "shared-secret-value-0123456789abcdef").unwrap();
//! let verifier = AuthVerifier::shared_secret_from_str("service-id", "shared-secret-value-0123456789abcdef").unwrap();
...
/// let token = provider.get_token()?;
/// // Token format: id:timestamp:nonce:claims:mac
...
/// let provider = AuthProvider::shared_secret_from_str("my-service", "shared-secret-value-0123456789abcdef").unwrap();
/// let verifier = AuthVerifier::shared_secret_from_str("my-service", "shared-secret-value-0123456789abcdef").unwrap();
///

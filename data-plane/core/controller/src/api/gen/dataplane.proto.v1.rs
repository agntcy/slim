        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn open_channel(
            ...
            request: impl tonic::IntoStreamingRequest<
                Message = ::slim_datapath::api::proto::dataplane::v1::Message,
            >,
        ) -> std::result::Result<
            tonic::Response<
                tonic::codec::Streaming<
                    ::slim_datapath::api::proto::dataplane::v1::Message,
                >,
            >,
            tonic::Status,
        > {
    ...
    pub trait DataPlaneService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn open_channel(
            ...
            request: tonic::Request<
                tonic::Streaming<::slim_datapath::api::proto::dataplane::v1::Message>,
            >,
        ) -> std::result::Result<
            ...
            match req.uri().path() {
                "/dataplane.proto.v1.DataPlaneService/OpenChannel" => {
                    ...
                    > for OpenChannelSvc<T> {
                        type Response = ::slim_datapath::api::proto::dataplane::v1::Message;

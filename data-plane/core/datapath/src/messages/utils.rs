...
/// SUBSCRIPTION_ACK_ID is used to request/identify subscription acknowledgments.
/// The value should be a unique string generated by the requester.
pub const SUBSCRIPTION_ACK_ID: &str = "SUBSCRIPTION_ACK_ID";

/// SUBSCRIPTION_ACK_SUCCESS indicates if a subscription operation succeeded.
/// The value is set to `TRUE_VAL` or `FALSE_VAL`.
pub const SUBSCRIPTION_ACK_SUCCESS: &str = "SUBSCRIPTION_ACK_SUCCESS";

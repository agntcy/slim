...
class App:
    ...
    def create_session(self, destination:Name, egress_conn:builtins.int, config:SessionConfiguration) -> collections.abc.Awaitable[tuple[SessionContext, CompletionHandle]]: ...
    ...
    def connect(self, config:dict) -> collections.abc.Awaitable[int]: ...

...
use prost_types::compiler::{
    CodeGeneratorResponse, code_generator_response::File, CodeGeneratorRequest,
};
...
const UNARY_UNARY_STUB_METHOD_TEMPLATE: &str = r#"    async def {{METHOD_NAME}}(self, request: {{INPUT_TYPE_FULL_PATH}}, timeout=None) -> {{OUTPUT_TYPE_FULL_PATH}}:
...
const UNARY_STREAM_STUB_METHOD_TEMPLATE: &str = r#"    async def {{METHOD_NAME}}(self, request: {{INPUT_TYPE_FULL_PATH}}, timeout=None):
        """Call {{METHOD_NAME}} method."""
...
const STREAM_UNARY_STUB_METHOD_TEMPLATE: &str = r#"    async def {{METHOD_NAME}}(self, request_iterator, timeout=None) -> {{OUTPUT_TYPE_FULL_PATH}}:
        """Call {{METHOD_NAME}} method."""
...
const STREAM_STREAM_STUB_METHOD_TEMPLATE: &str = r#"    async def {{METHOD_NAME}}(self, request_iterator, timeout=None):
        """Call {{METHOD_NAME}} method."""
...
class _{{SERVICE_NAME}}Servicer_{{METHOD_NAME}}_Handler:
    ...
    async def handle(self, request: bytes, context: slim_bindings.Context) -> bytes:
        ...
        response = await self.servicer.{{METHOD_NAME}}(request_msg, context.message, context)
...
class _{{SERVICE_NAME}}Servicer_{{METHOD_NAME}}_Handler:
    ...
    async def handle(self, request: bytes, context: slim_bindings.Context, sink: slim_bindings.ResponseSink):
        request_msg = {{INPUT_TYPE_FULL_PATH}}.FromString(request)
        response_iter = self.servicer.{{METHOD_NAME}}(request_msg, context.message, context)

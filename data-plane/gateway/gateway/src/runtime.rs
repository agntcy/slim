...
use agp_gw_config::component::configuration::ConfigurationError;
...
pub fn build(config: &RuntimeConfiguration) -> Result<GatewayRuntime, ConfigurationError> {
...
mod tests {
    ...
    fn test_runtime_configuration() {
        ...
        assert_eq!(config.thread_name, "gateway");
